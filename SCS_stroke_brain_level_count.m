...
subName = {'SBSN_S_044','SBSN_S_055','SBSN_S_066','SBSN_S_077'};%,'SMA05_003','SMA05_004'};
% 
allData = {};
...
saveas(gcf, ['D:\SBSN\stroke\SCS\Brain_tsnr.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Brain_tsnr.svg']);
...
% Save the plot as a PNG image
saveas(gcf, ['D:\SBSN\stroke\SCS\Brain_voxel_success_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Brain_voxel_success_z', num2str(zScore), '.svg']);
...
% Save the plot as a PNG image
% saveas(gcf, '['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Brain_voxel_diff.png');
% saveas(gcf, '['D:\SBSN\Data\Spine\analysis\', subName{1}(1:5), Brain_voxel_diff.svg');
...
% Save the plot as a PNG image
saveas(gcf, ['D:\SBSN\stroke\SCS\Brain_zscore_success_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Brain_zscore_success_z', num2str(zScore), '.svg']);
...
% Save the plot as a PNG image
% saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_zscore_diff.png');
% saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_zscore_diff.svg');
...
% % Save the plot as a PNG image
% % saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_voxel_slope.png');
% % saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_voxel_slope.svg');
% 
% 
% 
% time = [1, 2, 3, 4, 5];
...
% xticklabels({'1-2','1-3','1-4','1-5','1-6'})
% % Save the plot as a PNG image
% % saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_zscore_slope.png');
% % saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_zscore_slope.svg');
...
% Save the plot as a PNG image
saveas(gcf, ['D:\SBSN\stroke\SCS\Brain_voxel_area_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Brain_voxel_area_z', num2str(zScore), '.svg']);
...
% Save the plot as a PNG image
saveas(gcf, ['D:\SBSN\stroke\SCS\Brain_zscore_area_z', num2str(zScore), '.png']);
saveas(gcf, ['D:\SBSN\stroke\SCS\Brain_zscore_area_z', num2str(zScore), '.svg']);
...
% 
% % % Save the plot as a PNG image
% % saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_voxel_control.png');
% % saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_voxel_control.svg');
% 
% 
...
% 
% % Save the plot as a PNG image
% % saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_zscore_control.png');
% % saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_zscore_control.svg');
% 
...
% 
% % Save the plot as a PNG image
% % saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_active_control_all.png');
% % saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_active_control_all.svg');
% pper_limb\Spine
...
% Save the plot as a PNG image
% saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_zscore_control_all.png');
% saveas(gcf, '['D:\SBSN\Data\Brain\analysis\', subName{1}(1:5), Brain_zscore_control_all.svg');
