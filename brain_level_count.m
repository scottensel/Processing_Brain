...
for i = 1:length(subName)
    ...
    for j = 1:4
        ...
        motionData = importdata(fullfile('D:\SMA\MRI_data_upper_limb\Brain', subName{i}, 'func', ['func', num2str(j)], 'fmri_moco.txt'));
...
[brainLevels, ~] = cbiReadNifti('D:\SMA\MRI_data_upper_limb\Brain\template\MNI152_T1_brain_mask.nii');
...
for i = 1:length(subName)
    ...
    direc = fullfile('D:\SMA\MRI_data_upper_limb\Brain', subName{i}, 'func');
